...
// 公式とディレクトリの場所が違うので注意dist/cjsに変更しないとだめ
...
// ここにパラメータが入ってnotionAPIのgetSinglePostに渡してプロパティをフィルタリングして値が一致したら
// その値だけを返す処理を行う notionAPIで作ったpostの値がこちらに返ってくる
  ...
  return (
    <section className='container lg:px-2 px-5 h-screen lg:w-2/5 mx-auto mt-20'>
        ...
        <div className='mt-10 font-medium'>
          <ReactMarkdown children={post.markdown} components={{
